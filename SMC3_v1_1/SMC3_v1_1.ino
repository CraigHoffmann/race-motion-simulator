...
// Uncomment the following line to reverse the direction of Motor 1-3.
...
// Uncomment the following lines to limit negative values for harness.

//#define NO_NEGATIVE_MOTOR3
#define NO_POSITIVE_MOTOR3
...
#ifdef NO_NEGATIVE_MOTOR3
            if (Target3<500)
			{
				Target3 = 500;
			}
#endif
#ifdef NO_POSITIVE_MOTOR3
            if (Target3>524)
      {
        Target3 = 524;
      }
...
//                    default:
        ...
        case 'v':
            ...
            {
                SendValue('v',110,ComPort);     // Software Version - divide by 100 to get version - ie 101= ver1.01
            }
            break;
        case 'e':
